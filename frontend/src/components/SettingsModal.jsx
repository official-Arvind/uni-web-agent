...
const SettingsModal = ({ onClose, setActiveTab }) => {
  ...
  return (
    <div className="modal-overlay" style={{ backdropFilter: 'blur(20px)', animation: 'fadeIn 0.4s ease-out' }}>
      <div className="modal-content liquid-glass" style={{ 
        ...
        <h2 className="gradient-text" style={{ textTransform: 'uppercase', letterSpacing: '3px', borderBottom: '2px dashed rgba(255,255,255,0.2)', paddingBottom: '16px', marginBottom: '32px', fontSize: '28px', fontWeight: 900 }}>
          GLOBAL <span style={{ color: '#00ff64' }}>SETTINGS</span>
        </h2>
        
        <div className="bento-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '24px', marginBottom: '32px' }}>
          
          <div className="bento-item liquid-glass" style={{ padding: '24px', borderRadius: '16px', border: '1px solid rgba(255,255,255,0.05)', position: 'relative' }}>
            <div style={{ position: 'relative', marginBottom: '16px' }}>
              ...
              <label style={{
                ...
                background: backendUrl ? '#121212' : 'transparent',
                padding: '0 8px',
          ...
          <div className="bento-item liquid-glass" style={{ padding: '24px', borderRadius: '16px', border: '1px solid rgba(255,255,255,0.05)', position: 'relative' }}>
            <div style={{ position: 'relative', marginBottom: '16px' }}>
              ...
              <label htmlFor="apiKey" style={{
                ...
                background: apiKey ? '#121212' : 'transparent',
                padding: '0 8px',
                transition: 'all 0.3s cubic-bezier(0.4, 0, 0.2, 1)',
                pointerEvents: 'none',
                textTransform: 'uppercase',
          ...
          <div className="bento-item liquid-glass" style={{ gridColumn: '1 / -1', padding: '24px', borderRadius: '16px', border: '1px solid rgba(255,255,255,0.05)', position: 'relative' }}>
            <h3 style={{ margin: '0 0 24px 0', fontSize: '18px', color: '#fff', textTransform: 'uppercase', letterSpacing: '1px' }}>Proxy Configuration</h3>
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '24px' }}>
              <div style={{ position: 'relative' }}>
                ...
                <label htmlFor="proxyServer" style={{
                  ...
                  background: proxyServer ? '#121212' : 'transparent',
                  padding: '0 8px',
                  transition: 'all 0.3s cubic-bezier(0.4, 0, 0.2, 1)',
                  pointerEvents: 'none',
                  textTransform: 'uppercase',
              ...
              <div style={{ position: 'relative' }}>
                ...
                <label htmlFor="proxyUser" style={{
                  ...
                  background: proxyUser ? '#121212' : 'transparent',
                  padding: '0 8px',
                  transition: 'all 0.3s cubic-bezier(0.4, 0, 0.2, 1)',
                  pointerEvents: 'none',
                  textTransform: 'uppercase',
              ...
              <div style={{ position: 'relative' }}>
                ...
                <label htmlFor="proxyPass" style={{
                  ...
                  background: proxyPass ? '#121212' : 'transparent',
                  padding: '0 8px',
                  transition: 'all 0.3s cubic-bezier(0.4, 0, 0.2, 1)',
                  pointerEvents: 'none',
                  textTransform: 'uppercase',
            ...
            <div style={{ fontSize: '0.8rem', marginTop: '16px', color: '#888', fontWeight: 'bold' }}>
          ...
          <div className="bento-item liquid-glass" style={{ gridColumn: '1 / -1', padding: '24px', borderRadius: '16px', border: '1px solid rgba(255,255,255,0.05)', display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: '20px' }}>
            <div style={{ flex: '1 1 300px' }}>
              <h3 style={{ margin: '0 0 12px 0', fontSize: '18px', color: '#fff', textTransform: 'uppercase', letterSpacing: '1px' }}>Authentication & Profiles</h3>
